...
$name = $_SESSION["user"];
	...
	$sqll=mysqli_query($conn,"Select * from flatrent where id='$idedit'");
...
<body>
  ...
  <main id="content" role="main">
   ...
   <center>
	<div class="container">
    <form  class="well form-horizontal" action="flatrentupdate.php" method="POST"  id="contact_form">
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select Floor <span style="color:red">*</span></label>
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="floorno" class="form-control selectpicker" disabled >
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select Room <span style="color:red">*</span></label>
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="roomno" class="form-control selectpicker" disabled >
