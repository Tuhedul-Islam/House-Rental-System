            ...
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                  ...
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="#">Add Flat</a>
                  </li>
                </ul>
              </li>
              <!-- End Flat -->
  ...
  <main id="content" role="main">
   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="POST"  id="contact_form">
		...
		<h2 style="color:red"><?php echo"$check"; ?></h2>
		
		<!-- Select Basic -->
		<div class="form-group"> 
		  <label class="col-md-4 control-label">HouseName <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="hname" class="form-control selectpicker" required >
				<?php 
					...
					?>
						<option value="<?php echo $row['houseName']." "; echo "[".$row['selectArea']."]"; ?>"> 
							<?php echo $row['houseName']." "; echo "[".$row['selectArea']."]"; ?>
						</option>
				<?php
					}
				?>
		...
		<!-- Select Basic -->
		<div class="form-group"> 
		  <label class="col-md-4 control-label">TypeId <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="rentertype" class="form-control selectpicker" required >
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">FloorNo <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="floorno" placeholder="FloorNo" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">RoomNo <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="roomno" placeholder="RoomNo" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">RentPrice <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="rentprice" placeholder="RentPrice" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
			<input type="submit" value="Create" name="submit" class="btn btn-success" ><span class="glyphicon glyphicon-send"></span></input>
		  </div>
		</div>
