...
$name = $_SESSION["user"];
	...
	$sqll=mysqli_query($conn,"Select * from addflat where id='$idedit'");
...
<body>
  ...
  <main id="content" role="main">
   ...
   <center>
	<div class="container">
    <form  class="well form-horizontal" action="addflatupdate.php" method="POST"  id="contact_form">
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">HouseName <span style="color:red">*</span></label>
			...
			<select name="hname" class="form-control selectpicker" disabled >
				<option value=""> 
					<?php echo $row['hname']." "; ?>
				</option>
			</select>
		...
		<div class="form-group">
		  ...
		  <input name="floorno" value="<?php echo $row['floorno']; ?>" class="form-control"  type="text" disabled>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">RoomNo <span style="color:red">*</span></label>  
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="roomno" value="<?php echo $row['roomno']; ?>" class="form-control"  type="text" disabled>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">RentPrice <span style="color:red">*</span></label>  
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="rentprice" value="<?php echo $row['rentprice']; ?>" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
