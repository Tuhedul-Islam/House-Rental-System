   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="POST"  id="contact_form">
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select House <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="hname" class="form-control selectpicker" required >
				<option value="<?php echo $row['hname']; ?>"> 
					<?php echo $row['hname']; ?>
				</option>
			</select>
		  </div>
		...
		<!-- Select Basic -->
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select Floor <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="floorno" class="form-control selectpicker" required >
			    <option value="<?php echo $row['floorno']; ?>"> 
		...
		<!-- Select Basic -->
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select Room <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="roomno" class="form-control selectpicker" required >
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">Representative PhnNo <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="representativephn" placeholder="Representative PhnNo" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
			<input type="submit" value="Make Rent" name="submit" class="btn btn-success" ><span class="glyphicon glyphicon-send"></span></input>
		  </div>
		</div>
