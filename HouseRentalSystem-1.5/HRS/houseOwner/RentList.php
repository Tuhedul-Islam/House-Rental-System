            ...
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                    aria-labelledby="shopMegaMenu">
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="#">Rent List</a>
                  </li>
                </ul>
              </li>
              <!-- End Rent -->
...
<main id="content" role="main">
    ...
    <div class="container space-2 text-center space-3-top--lg">
      <h2>Rent List</h2>
      <p class="lead">All Rented Flats Are Shown by System Which are Editable</p>
    </div>
    <!-- End Hero Section -->
        ...
        <article class="card mb-5">
          <div class="card-body p-5">
            <table class="table table-striped">
				...
				<tbody>
				<?php 
					$sqll=mysqli_query($conn,"Select * from flatrent where houseOwner='$name'");
					...
					?>
						<tr>
							...
							<td><?php echo $row['representativephn']; ?></td>
							<td><?php echo $row['date']; ?></td>
							<td><a href="flatrentedit.php?id=<?php echo $row['id']; ?>"><span class="fas fa-user-edit"> Edit</span></a></td>
							<td><a href="flatrentdelete.php?id=<?php echo $row['id']; ?>"><span class="fas fa-trash-alt"> Delete</span></a></td>
						</tr>
					<?php
					}
					?>
