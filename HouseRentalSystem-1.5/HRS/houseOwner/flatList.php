            ...
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                    aria-labelledby="shopMegaMenu">
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="#">Flat List</a>
                  </li>
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
...
<main id="content" role="main">
    ...
    <div class="container space-2 text-center space-3-top--lg">
      <h2>Flat List</h2>
      <p class="lead">All Flats Are Shown by System Which are Editable</p>
    </div>
    <!-- End Hero Section -->
        ...
        <article class="card mb-5">
          <div class="card-body p-5" style="overflow-x:auto;">
            <table class="table table-striped">
				...
				<?php 
					$sqll=mysqli_query($conn,"Select * from addflat where houseOwner='$name'");
					...
					?>
						<tr>
							...
							<td><?php echo $row['rentertype']; ?></td>
							<td><?php echo $row['description']; ?></td>
							<td><a href="addflatedit.php?id=<?php echo $row['id']; ?>"><span class="fas fa-user-edit"> Edit</span></a></td>
							<td><a href="addflatdelete.php?id=<?php echo $row['id']; ?>"><span class="fas fa-trash-alt"> Delete</span></a></td>
							<td><a href="flatRent.php?id=<?php echo $row['id']; ?>"><span class="fas fa-arrow-alt-circle-right"> Rent</span></a></td>
						</tr>
					<?php
					}
					?>
          ...
          <div class="card-footer bg-gray-100 py-4 px-5">
            <div class="media">
              <img class="u-sm-avatar rounded-circle mr-3" src="../assets/img/100x100/img1.jpg" alt="Image">
