          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse py-0">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item u-header__nav-item"
                ...
                <a class="nav-link u-header__nav-link" href="houseInfo.php">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                  ...
                  data-animation-in="fadeInUp"
                  data-animation-out="fadeOut">
                <a id="shopMegaMenu" class="nav-link u-header__nav-link" href="renterInfo.php"
                   aria-haspopup="true"
                   aria-expanded="false"
                   aria-labelledby="shopSubMenu">
                   RenterInfo
  ...
  <main id="content" role="main">
   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="post"  id="contact_form">
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">House No <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="zip" placeholder="House No" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
          ...
          <div class="card-body p-5 " style="overflow-x:auto;">
            <table class="table table-striped">
				...
				<tr>
					...
					<td>entryDate</td>
					<td>leaveDate</td>
					<td><a href="#"><span class="fas fa-user-edit"> Edit</span></a></td>
				</tr>
				<tr>
					<td>Name</td>
					<td>0198</td>
