          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse py-0">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                  ...
                  data-animation-in="fadeInUp"
                  data-animation-out="fadeOut">
                <a id="shopMegaMenu" class="nav-link u-header__nav-link" href="flatInfo.php"
                   aria-haspopup="true"
                   aria-expanded="false"
   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="post"  id="contact_form">
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">RenterPhnNo <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="zip" placeholder="RenterPhnNo" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
	...
	<div class="container space-3-bottom--lg">
	   <h2 style="color:#5eccbe">Flat Info</h2>
	  ...
	  <h2 style="color:#5eccbe">Member Info</h2>
	  <div class="card-deck d-block d-lg-flex">
        <!-- Blog Grid -->
        <article class="card mb-5">
          <div class="card-body p-5 " style="overflow-x:auto;">
