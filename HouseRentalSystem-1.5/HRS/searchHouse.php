<?php
	...
	if(isset($_POST['submit'])){
		...
		$selectArea=$_POST['area'];
		
		$sqll=mysqli_query($conn,"SELECT * from addhouse 
		WHERE selectCity LIKE '%$selectCity%' and selectArea LIKE '%$selectArea%'");
   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="POST"  id="contact_form">
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select City <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
			<select name="city" class="form-control selectpicker" required >
			  <option value="Dhaka"> Dhaka</option>
			  <option value="Chittagong" disabled> Chittagong</option>
		...
		<!-- Select Basic -->
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Select Area <span style="color:red">*</span></label>
			<div class="col-md-4 selectContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
			<input type="submit" value="Search" name="submit" class="btn btn-success" > <span class="glyphicon glyphicon-send"></span></input>
		  </div>
		</div>
            ...
            <table class="table table-striped">
				...
				<?php 
					if(!empty($sqll))
					{
						...
						?>
							<tr>
								<td><?php echo $row['houseOwner']; ?></td>
								<td><?php echo $row['selectCity']; ?></td>
								<td><?php echo $row['selectArea']; ?></td>
								<td><?php echo $row['houseName']; ?></td>
								<td><?php echo $row['address']; ?></td>
								<td><?php echo $row['description']; ?></td>
								<td><a href="#"><span class="far fa-eye"> Visit</span></a></td>
							</tr>
				<?php
						}
					}
