              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                  ...
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="#">Member List</a>
                  </li>
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
...
<main id="content" role="main">
    ...
    <div class="container space-2 text-center space-3-top--lg">
      <h2>Member List</h2>
      <p class="lead">All Flats Members Are Shown by System Which are Editable</p>
    </div>
    <!-- End Hero Section -->
        ...
        <article class="card mb-5">
          <div class="card-body p-5" style="overflow-x:auto;">
            <table class="table table-striped">
				...
				<tbody>
				<?php 
					$sqll=mysqli_query($conn,"Select * from addmember where username='$name'");
					...
					<tr>
						...
						<td><a href="addmemberedit.php?id=<?php echo $row['id']; ?>"><span class="fas fa-user-edit"> Edit</span></a></td>
						<td><a href="addmemberdelete.php?id=<?php echo $row['id']; ?>"><span class="fas fa-trash-alt"> Delete</span></a></td>
					</tr>
				<?php
					}
					?>
