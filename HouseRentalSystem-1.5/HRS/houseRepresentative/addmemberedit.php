...
$name = $_SESSION["user"];
	...
	$sqll=mysqli_query($conn,"Select * from addmember where id='$idedit'");
...
<body>
          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse py-0">
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item u-header__nav-item"
                ...
                <a class="nav-link u-header__nav-link" href="houseRepresentative.php">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <ul id="shopSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                  ...
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="memberList.php">Member List</a>
                  </li>
                  <li class="dropdown-item u-header__sub-menu-list-item py-0">
                    <a class="nav-link u-header__sub-menu-nav-link" href="addMember.php">Add Member</a>
                  </li>
                </ul>
              </li>
              <!-- End House -->
  ...
  <main id="content" role="main">
   ...
   <center>
	<div class="container">
    <form  class="well form-horizontal" action="addmemberupdate.php" method="POST"  id="contact_form">
		...
		<div class="form-group">
		  ...
		  <input name="membername" value="<?php echo $row['membername']; ?>" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">LeaveDate <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="leavedate" value="<?php echo $row['leavedate']; ?>" type="date" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">NID <span style="color:red">*</span></label>  
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="nid" value="<?php echo $row['nid']; ?>" class="form-control"  type="text" disabled>
			</div>
		</div>
		</div>
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label">PhnNo <span style="color:red">*</span></label>  
			<div class="col-md-4 inputGroupContainer">
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="phnno" value="<?php echo $row['phnno']; ?>" class="form-control"  type="text" disabled>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
			<input type="submit" value="Create" name="submit" class="btn btn-success" > <span class="glyphicon glyphicon-send"></span></button>
		  </div>
		</div>
