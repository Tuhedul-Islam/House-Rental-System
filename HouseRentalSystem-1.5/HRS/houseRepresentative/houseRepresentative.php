...
<main id="content" role="main">
    ...
    <div class="container space-2 text-center space-3-top--lg">
      <h2>Member List</h2>
      <p class="lead">All Members Are Shown by System Which are Editable</p>
    </div>
    <!-- End Hero Section -->
		  ...
		  <div class="card-deck d-block d-lg-flex">
			...
			<article class="card mb-5">
			  <div class="card-body p-5">
				<small class="d-block-2"><?php echo $row['entrydate']; ?></small>
				<h2 class="h5">
				  <a href="single-article-classic.html"><?php echo $row['membername']; ?></a>
				</h2>
				<p class="mb-0"><?php echo $row['occupation']; ?></p>
			  </div>
