<?php
	include"addmemberinsert.php";
	//session_start();
	$name = $_SESSION["user"];
	$permission = $_SESSION['permission'];
	
	if(empty($name) && $permission==false){
   ...
   <center>
    ...
    <form  class="well form-horizontal" action="" method="POST"  id="contact_form">
		...
		<div class="form-group">
		  ...
		  <input name="membername" placeholder="Name" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">PhnNo <span style="color:red">*</span></label>  
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
		  <input name="phnno" placeholder="PhnNo" class="form-control"  type="text" required>
			</div>
		</div>
		</div>
